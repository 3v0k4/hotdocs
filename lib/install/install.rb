...
unless system("command -v deno > /dev/null 2>&1")
  say "Install deno before running this task. Read more: https://deno.com"
  exit 1
end

if File.exist?("app/assets/config/manifest.js")
  say "Migrate to Propshaft before running this task. Read more: https://github.com/rails/propshaft/blob/main/UPGRADING.md#3-migrate-from-sprockets-to-propshaft"
  exit 1
end
